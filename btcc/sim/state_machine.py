...
- Default zone: S >= long_threshold (inclusive). Optional threshold_strict:
  zone is S > long_threshold.
"""
...
class CrossingStateMachine:
    ...
    # If True: zone is S > long_threshold (strict). Default False preserves S >= long_threshold.
    ...
    def from_dict(cls, data: dict[str, Any]) -> "CrossingStateMachine":
        sm = cls(
            ...
            threshold_strict=bool(data.get("threshold_strict", False)),
        )
